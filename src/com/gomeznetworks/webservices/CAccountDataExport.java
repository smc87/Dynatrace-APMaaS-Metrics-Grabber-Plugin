...
public class CAccountDataExport  implements java.io.Serializable {
    private com.gomeznetworks.webservices.COpStatusData status;

    private com.gomeznetworks.webservices.CAccountData accountConstraints;

    public CAccountDataExport() {
    }

    public CAccountDataExport(
           com.gomeznetworks.webservices.COpStatusData status,
           com.gomeznetworks.webservices.CAccountData accountConstraints) {
           this.status = status;
    ...
    /**
     * Gets the status value for this CAccountDataExport.
     * 
     * @return status
     */
    ...
    /**
     * Sets the status value for this CAccountDataExport.
     * 
     * @param status
     */
    ...
    /**
     * Gets the accountConstraints value for this CAccountDataExport.
     * 
     * @return accountConstraints
     */
    public com.gomeznetworks.webservices.CAccountData getAccountConstraints() {
        return accountConstraints;
    }


    /**
     * Sets the accountConstraints value for this CAccountDataExport.
     * 
     * @param accountConstraints
     */
    public void setAccountConstraints(com.gomeznetworks.webservices.CAccountData accountConstraints) {
        this.accountConstraints = accountConstraints;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CAccountDataExport)) return false;
        CAccountDataExport other = (CAccountDataExport) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CAccountDataExport.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://gomeznetworks.com/webservices/", "CAccountDataExport"));
